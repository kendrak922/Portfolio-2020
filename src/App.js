  ...
  return (
    ...
    <div ref={node}>
        ...
        <div id='about-me'>
            ...
            <p >As a people person and a liberal arts grad, I never thought my journey would involve coding. I was initially drawn to the field because I wanted to use technology to help people. I stayed because I found a home in web development that enabled me to use creativity and critical thinking skills in new ways while constantly learning. If I am not trying a new web develment tool, I am probably at a brewery with friends, bouldering, experimenting in the kitchen, or reading a good book.<br></br><br></br>  I like to work on projects that are mission driven and solutions oriented. I love beautiful design. Most of all I love talking about projects, learning technology, and encouraging others to explore the world of web development. If you are just getting started on your coding journey and want to learn more, let's talk. </p>
            <button className="resume" href={resume} download>Resume</button>
            </div>
        </div>
        <div></div>
        <Footer />
